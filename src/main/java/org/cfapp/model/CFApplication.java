...
public class CFApplication implements Serializable, JsonMessage {
	...
	public CFApplication(String id, String name, Integer instanceCount) {
		this.id=id;
		this.name=name;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CFApplication other = (CFApplication) obj;
		if (id == null) {
			if (other.id != null)
				return false;
